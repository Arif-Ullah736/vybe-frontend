    ...
    <div className="w-full min-h-screen  bg-black">
      ...
      <div className=" w-full min-h-[100vh] flex justify-center ">
        <div className="w-full max-w-[900px] flex flex-col items-center rounded-t-[30px]  bg-white relative gap-[20px] pt-[30px] pb-[100px]">
          {profileData?._id === userData?._id && (
            <div className="w-[60%] max-w-[400px] h-[80px] bg-white  rounded-full flex justify-center items-center gap-[10px]">
              {/* post  */}
              <div
                className={`  ${postType === "post" ? "bg-black text-white" : ""} w-[28%] h-[80%]  flex justify-center items-center text-[19px] font-semibold hover:bg-black rounded-full hover:text-white cursor-pointer hover:shadow-2xl hover:shadow-black`}
              ...
              .{/* saved  */}
              <div
                className={`  ${postType === "saved" ? "bg-black text-white" : ""} w-[28%] h-[80%]  flex justify-center items-center text-[19px] font-semibold hover:bg-black rounded-full hover:text-white cursor-pointer hover:shadow-2xl hover:shadow-black`}
